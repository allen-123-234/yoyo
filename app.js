...
//  API fetch helpers
// ----------------------------------------------------------------
// ✅ 設定你自己的 Cloudflare Worker 網址（部署後替換這裡）
//    部署完成後把下面的 URL 換成你的 Worker 網址，例如：
//    const CF_WORKER_URL = 'https://twse-proxy.yourname.workers.dev';
const CF_WORKER_URL = 'https://twse-proxy.YOUR_NAME.workers.dev'; // ← 部署後改這裡

// 多個 CORS Proxy，CF Worker 最優先，其他備用
const PROXIES = [
  // 🥇 自己的 Cloudflare Worker — 最穩定，永久免費
